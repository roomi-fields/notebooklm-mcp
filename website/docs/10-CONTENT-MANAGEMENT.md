...
description: Generate NotebookLM Studio outputs — audio podcasts, video brief and explainer, infographics, reports, presentations, data tables — programmatically via MCP or HTTP API.
keywords:
  [
    notebooklm audio,
    notebooklm video,
